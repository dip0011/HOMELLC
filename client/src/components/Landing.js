  ...
  return (
    <>
      <div className="">
        <div class="row">
          <div class="col-2 p-0">
            <div class="sidebar bg-light d-flex flex-column justify-content-around align-items-center">
                <div className="p-4">
                  <img class="mb-5" src={Logo} alt="logo" width={100}/>
                  <div className="c-pointer p-1 font-weight-bold">NATIONAL INSIGHTS</div>
                  <div className="c-pointer p-1 font-weight-bold">LOCAL INSIGHTS</div>
                </div>
            </div>
          </div>
          <div class="col-10 p-2">
              <nav class="d-flex justify-content-between navbar navbar-expand-lg">
                <form class="d-flex justify-content-between form-inline m-2 my-lg-0">
                  <input class="search-input" type="search" placeholder="Search" aria-label="Search"/>
                  <button class="search-button" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search pb-1" viewBox="0 0 16 16"> <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/></svg></button>
                </form>
